...
const outbox_worker_service_1 = require("./outbox-worker.service");
...
exports.OutboxModule = OutboxModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [outbox_worker_service_1.OutboxWorkerService],
        exports: [outbox_worker_service_1.OutboxWorkerService],
    })
], OutboxModule);
